  ...
  if (WITH_AMD_GPU)
    ...
    if(hip_library_SRCS)
      if (hip_library_SHARED OR hip_library_shared) # build *.so
        ...
        target_link_libraries(${TARGET_NAME} "-Wl,--no-as-needed" /opt/rocm/hip/lib/libhip_hcc.so /opt/rocm/hip/lib/libhip_device.a /opt/rocm/rccl/lib/librccl.so /opt/rocm/hiprand/lib/libhiprand.so)
        find_fluid_modules(${TARGET_NAME})
      endif()
